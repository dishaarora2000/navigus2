...
if(@$_GET['fdid'] && $_SESSION['key']=='disha2000') {
$id=@$_GET['fdid'];
...
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='disha2000') {
$demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='disha2000') {
$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='disha2000') {
$name = $_POST['name'];
...
//add course
if(isset($_SESSION['key'])){
  if(@$_GET['q']== 'addcourse' && $_SESSION['key']=='disha2000') {
  $name = $_POST['name'];
  $name= ucwords(strtolower($name));
  $q3=mysqli_query($con,"INSERT INTO quiz VALUES  ('$name' , NOW())");
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='disha2000') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
...
else if( $_SESSION['key']!='disha2000')
{
