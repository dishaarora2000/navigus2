...
<body  style="background:#99cc32;">
<div class="header">
<div class="row">
<div class="col-lg-6">
<span class="logo">Explore Your Knowledge</span></div>
<?php
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==6 || @$_GET['q']==7) echo'active"'; ?>">
          <a href="#" class="dropdown-toggle1" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Course<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=6️">Add course</a></li>
            <li><a href="dash.php?q=7️">remove Course</a></li>
...
if(@$_GET['q']==6 && !(@$_GET['step']) ) {
  $result = mysqli_query($con,"SELECT * FROM addcourse ORDER BY `name`") or die('Error');
  echo ' 
<div id="main-content" class="container">
<div class="main-content-inner">
<form style ="background-color:black;color:White;margin:60px;padding:80px;font-size:60px" method="POST">
Enter the Course: <input type="text" name="addc" maxheight="20" maxwidth="40">
<br><br>
<input type="submit" value="insert rec" name="insert" ></button>';}
